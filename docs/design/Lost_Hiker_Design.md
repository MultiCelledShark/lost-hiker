...
## ACT I CORE SYSTEMS
  ECHO — The Glade Serpent

    Echo is an ancient forest serpent whose biology evolved to navigate and “listen” to ley-line currents. She cannot speak verbally. Her emotional broadcasts (pressure, pulses, scent, vibration) are interpreted by the player’s damaged HT radio.

    Radio v1

      Before tuning, Echo’s communication is:
      impressionistic
      emotional
      fragmentary
      poetic static translated imperfectly

      Example output:

        [RADIO] Warm… curious… testing your scent.

        [RADIO] A pulse of recognition.

      Radio Upgrade Event

        Triggered when:
          Echo rapport ≥ 5
          The player camps near the Glade after experiencing a radio glitch
          Echo requests the radio:
        Vore ON → full swallow radio and player(harmless)
        Vore OFF → swallows just the radio
        Overnight she “tunes” the device.
        The next morning, radio_version = 2.

    Radio v2
      Echo’s speech becomes:
        coherent sentences
        still conveyed via radio
        warm, personal, characterful
        highly race-aware

    ECHO — RACE-SPECIFIC PERCEPTION

      Echo senses resonance, not appearance.
      Each race has a distinct emotional/frequency “shape.”

      Humans — The Quiet Flame

        Quiet presence, low resonance.
        Echo becomes protective and curious.
        v1: [RADIO] Strange… unrooted… soft flame.
        v2: “Your emotions are points, not waves. Unusual. Beautiful.”

      Wolf-Kin — The Greybound Pulse

        Warm, emotional, instinct-forward.
        Echo finds them bright and alive.
        v1: [RADIO] Warm. Sharp. Pack-hum.
        v2: “Your presence crackles like dry leaves. Controlled… mostly.”

      Elves — The Verdant Memory

        Familiar, nostalgia-triggering, forest-aligned.
        v1: [RADIO] Moss-scent. Old memory.
        v2: “The forest remembers your people.”

      Dwarves — The Stone-Blooded

        Dense, resonant, geometrically emotional.
        v1: [RADIO] Heavy. Steady. Buried roots.
        v2: “Stone-blood. Your presence steadies the ground.”

      Cow-Kin — The Warm Meadow

        Aromatic, warm, comforting. Echo teases them.
        v1: [RADIO] Warm. Cozy. Echo circles your scent
        v2: “You smell delicious—comfort, not danger.”

      Lizard-Kin — The Scalefolk Heat-Lines

        Clear heat signatures, precise scent, alert.
        v1: [RADIO] Warm-scale. Sharp scent.
        v2: “Your signals are clean. Your instincts cut through distortions.”

  THE HT RADIO — Core Tool
    Radio v1

      Distorted translation
      Can “ping” Echo
      Receives emotional impressions

    Radio v2

      Unlocked after Echo eats/attunes the radio:
        Sentences
        Clear dialogue
        Future creature communication
        Runestone resonance tuning
        Ley-line sense enhancements
      The radio is the universal communication interface of the game.

  MORTAR CRAFTING (FOR RUNESTONE REPAIR)

    Mortar creation uses the “brewing” system for now.

    Ingredients:
    Clay (gathered at creek)
    Sand (gathered at creek)
    Ash (from campfire)

    Optional resin (tree sap, adds flavor + slight success bonus)

  Tool:

    Gold Pan (tin pan found near the creek or left behind by the lost miner)

    Process:
    At camp:
      brew → Mix Primitive Mortar

      Result:
        primitive_mortar item

        Used only for runestone repair.

    Echo comments:
      v1: [RADIO] Grainy… sticky… strong enough.
      v2: “Clay, ash, sand… simple and clever. The stone accepts it.”

  RUNESTONE FRACTURES — ACT I MAIN QUEST LOOP

    The wizard’s failed ley-line stabilization spell fractured the forest’s magical grid.
    Runestones that once guided memory, geography, and natural cycles are now:
      cracked
      pulsing incorrectly
      humming with distorted resonance
      bleeding time anomalies

  Act I Core Quest: “Breath of the Forest”

    Repair three fractured runestones to partially stabilize the forest’s pulse.
    Repair Requires Solving Three Puzzle Layers:
      1. Physical Repair — “Restore the Glyph Track”

        Use primitive_mortar
        Fit the missing runestone fragment
        Align cracks and carvings

        Race benefits:
          Elves sense correct alignment
          Dwarves stabilize edges
          Lizard-Kin spot micro-fissures
          Wolf-Kin smell fresh vs stale clay
          Cow-Kin get enhanced Echo hints
          Humans rely entirely on Echo’s guidance
      ...
      2. Resonance Tuning — “Restore the Hum”
        Use HT radio to tune the harmonic frequency.
          Commands:
            use radio  
            adjust frequency  
            hold steady  
          ...
          Race insights:
            Dwarves feel bass-shift vibrations
            Elves hear faint harmonics
            Wolf-Kin react to emotional tones
            Lizard-Kin notice flickering lights
            Cow-Kin sense “comfort/discomfort”
            Humans get tuned-radio clarity via Echo

        Echo helps:

          [RADIO] “Steady… right there. Hold…”
        When correct, the mortar magically “sets.”

      3. Pulse Realignment — “Restore the Beat”

        The stone’s “heartbeat” must be restored.

        Steps:
          Brew correct tea (Dream Fern or similar)
          Drink it
          Meditate at stone
          Radio picks up a memory-echo
          Player “feels” the pulse realign

        Race sensory hallucinations differ:

          Elves see memory visions
          Dwarves perceive geometric lattices
          Lizard-Kin see heat maps
          Wolf-Kin feel instinctive pack-echo
          Cow-Kin sense warmth and emotional blending
          Humans experience nausea → clarity shift

    RUNESTONE REPAIR — OUTCOMES

      Repairing a stone:
        reduces distortions in local area
        improves event safety weighting
        lowers stamina cost in that region
        increases Echo rapport
        slightly improves radio signal clarity
        encourages Kirin to take interest
        stabilizes NPC routes
        causes herbs to grow in predictable cycles
        unlocks deeper forest navigation
        Three stones = Act I completion.

  KIRIN DISCOVERY SYSTEM (PREVIEW)

    The Kirin does not live at a fixed point.
    It appears when the player meets readiness conditions:

      one runestone repaired
      Echo rapport high enough
      brewed intuition-related teas
      reached depth ≥ 8
      behaved non-aggressively toward forest creatures
      camped several nights
      followed a Glow Elk
      visited specific landmarks (optional triggers)
      The Fallen Giant is simply the most common first meeting place, but any of the following may host the first encounter:

        Fallen Giant
        Whispering Hollow
        Old Rope Bridge
        Glow Elk convergence
        A runestone immediately after repair
        Dream Fern Grove
        A quiet clearing after Dream Fern tea

      This ensures discovery feels natural and mystical.
